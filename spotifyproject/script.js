    ...
    let a= await fetch(`/songs/`);
        ...
        let array=Array.from(anchors)
         for(let index=0;index<Array.length;index++){
            ...
            if(e.href.includes("/songs")&& !e.href.includes(".hitaccess")){
...
async function Main(){
    ...
    function search(){
        let siva=document.getElementById('find').value.toUppercase();
        let wonn=document.querySelectorAll('.card');
    ...
    //add an event listerner for close botton
